...
namespace Encryptor.Lib.Yandex.HttpUtils
{
    ...
    /// </summary>
    public class YandexSdkDriveItem
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == this.GetType() && this.Equals((YandexSdkDriveItem)obj);
        }
        ...
        protected bool Equals(YandexSdkDriveItem other)
        {
